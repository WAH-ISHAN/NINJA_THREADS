...
export function Wrapper() {
  return (
    <div className="lg:container mx-auto bg-gray-600 shadow-xl p-5 rounded-2xl transition-all duration-300 hover:shadow-2xl">
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <div >
          <div className="flex items-center gap-4">
            <Percent size="2rem" />
            <div>
              <h4 className="text-base text-black font-inter font-medium mb-2.5">
                Discount
              </h4>
